...
class BaseGlassDoor:
    ...
    def __get_list_employers(self, page: int) -> list:
        response: Response = self.__requests.post('https://www.glassdoor.com/graph',
                                                json=[
                                                        {
        ...
        return response.json()[0]['data']['employerSearchV2']['employerResults']
    ...
    def _get_all_detail(self, page: int) -> None:
        print(dumps(self.__get_list_employers(1), indent=4))
