...
json_data = {
    ...
    'data': {
        ...
        'rowsToReturn': 20,
        'trackingProperties': {
            'visitId': 'de071076-867f-4894-8f39-801993f4c4a8',
            'eventSeq': 9,
            'eventKey': 'de071076-867f-4894-8f39-801993f4c4a8.9',
        },
    },
    'clientInterface': 'desktop',
}

response = requests.post('https://www.traveloka.com/api/v2/experience/reviews', cookies=cookies, headers=headers, json=json_data)

# Note: json_data will not be serialized by requests
# exactly as it was in the original request.
#data = '{"fields":[],"data":{"experienceId":"4244872323737","skip":0,"rowsToReturn":20,"trackingProperties":{"visitId":"de071076-867f-4894-8f39-801993f4c4a8","eventSeq":9,"eventKey":"de071076-867f-4894-8f39-801993f4c4a8.9"}},"clientInterface":"desktop"}'
#response = requests.post('https://www.traveloka.com/api/v2/experience/reviews', cookies=cookies, headers=headers, data=data)
